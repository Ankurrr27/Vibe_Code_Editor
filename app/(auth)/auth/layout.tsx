...
const AuthLayout = ({children}:{children:React.ReactNode})=>{
    return (
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(233,63,63,0.22),_transparent_38%),linear-gradient(135deg,_#080808,_#131313_55%,_#1b1010)] px-6 py-12">
