...
export default async function Home() {
  ...
  return (
    <div className="relative z-20 flex min-h-screen flex-col items-center justify-start overflow-hidden px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
      ...
      <div className="relative my-4 flex flex-col items-center justify-center">
        ...
        <Image
          ...
          height={520}
          width={520}
          className="relative z-10 h-auto w-full max-w-[320px] md:max-w-[420px] xl:max-w-[520px]"
        />

        <h1 className="z-20 mt-5 max-w-4xl text-center text-4xl font-extrabold leading-[1.15] tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-rose-500 via-red-500 to-pink-500 dark:from-rose-400 dark:via-red-400 dark:to-pink-400 md:text-5xl xl:text-6xl">
          Vibe Code With Intelligence
        </h1>
      </div>

      <p className="mt-2 max-w-2xl px-4 py-8 text-center text-base text-gray-600 dark:text-gray-400 md:text-lg">
